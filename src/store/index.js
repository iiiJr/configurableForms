...
const store = new Vuex.Store({
  state: {
    componentList: [
      ...
      { type: 'select', title: '下拉列表', defaultValue: ['test1', 'test2'], id: 4 },
      { type: 'switch', title: '开关', id: 5 },
      { type: 'checkbox', title: '多选框', defaultValue: ['test1', 'test2'], id: 6 },
      { type: 'radio', title: '单选框', defaultValue: ['test1', 'test2'], id: 7 }
    ],
    canvasList: [
